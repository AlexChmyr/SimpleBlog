...
namespace SimpleBlog.Areas.Admin.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public ActionResult New(UsersNew form)
        {
            ...
            {
                ModelState.AddModelError("Username", "Username mast be unique");
            }
        ...
        private void SyncRoles(IList<RoleCheckbox> checkboxes, IList<Role> roles)
        {
            ...
            foreach (var toAdd in selectedRoles.Where(sr => !roles.Contains(sr)))
            {
                roles.Add(toAdd);
            }

            foreach (var toRemove in roles.Where(sr => !selectedRoles.Contains(sr)).ToList())
            {
